...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_22$0)) (not (in$0 x sk_?X_21$0))
                 (not (in$0 x (union$0 sk_?X_22$0 sk_?X_21$0)))))) :named P4))
...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_22$0)) (not (in$0 x sk_?X_21$0)))
                 (not (in$0 x (intersection$0 sk_?X_22$0 sk_?X_21$0)))))) :named P6))
...
(assert (! (or (Btwn$0 next$0 rev$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_22$0 next$0 rev$0 null$0))) :named P11))

(assert (! (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)) :named P12))

(assert (! (= sk_?X_20$0 (union$0 sk_?X_22$0 sk_?X_21$0)) :named P13))

(assert (! (= sk_?X_21$0 (lseg_domain$0 next$0 curr$0 null$0)) :named P14))

(assert (! (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)) :named P15))

(assert (! (lseg_struct$0 sk_?X_22$0 next$0 rev$0 null$0) :named P16))

(assert (! (not (in$0 null$0 Alloc$0)) :named P17))
...
(assert (! (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 null$0) (not (Btwn$0 next$0 curr$0 l1 null$0)))
                 (not (in$0 l1 (lseg_domain$0 next$0 curr$0 null$0)))))) :named P18))

(assert (! (or (Btwn$0 next$0 curr$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_21$0 next$0 curr$0 null$0))) :named P19))

(assert (! (= FP_Caller_2$0 (setminus$0 FP_Caller$0 FP$0)) :named P20))

(assert (! (= emptyset$0 (intersection$0 sk_?X_22$0 sk_?X_21$0)) :named P21))

(assert (! (= sk_?X_20$0 FP$0) :named P22))

(assert (! (= sk_?X_22$0 (lseg_domain$0 next$0 rev$0 null$0)) :named P23))

(assert (! (lseg_struct$0 sk_?X_21$0 next$0 curr$0 null$0) :named P24))

(assert (! (not (= curr$0 null$0)) :named P25))

(assert (! (not (in$0 curr$0 FP$0)) :named P26))
...
(assert (! (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 null$0) (not (Btwn$0 next$0 rev$0 l1 null$0)))
                 (not (in$0 l1 (lseg_domain$0 next$0 rev$0 null$0)))))) :named P27))
...
(get-interpolants (and P15 P4 P8 P6 P28 P31 P5 P16 P30 P17 P33 P14 P22 P3 P23 P26 P18 P24) (and P25 P12 P2 P34 P20 P21 P9 P27 P19 P32 P29 P7 P0 P11 P10 P1 P13))

...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_24$0)) (not (in$0 x FP$0))
                 (not (in$0 x (union$0 sk_?X_24$0 FP$0)))))) :named P5))
...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_24$0)) (not (in$0 x FP$0)))
                 (not (in$0 x (intersection$0 sk_?X_24$0 FP$0)))))) :named P6))
...
(assert (! (or (Btwn$0 next$0 curr_9$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_23$0 next$0 curr_9$0 null$0))) :named P11))

(assert (! (or (Btwn$0 next$0 lst_1$0 curr_9$0 curr_9$0)
    (not (lseg_struct$0 sk_?X_24$0 next$0 lst_1$0 curr_9$0))) :named P12))

(assert (! (= curr_9$0 lst_1$0) :named P13))

(assert (! (= sk_?X_21$0 FP$0) :named P14))

(assert (! (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)) :named P15))

(assert (! (= sk_?X_22$0 (union$0 sk_?X_24$0 sk_?X_23$0)) :named P16))

(assert (! (= sk_?X_24$0 (lseg_domain$0 next$0 lst_1$0 curr_9$0)) :named P17))
...
(assert (! (or (in$0 sk_?e_3$0 (intersection$0 sk_?X_24$0 sk_?X_23$0))
    ...
    (not (Btwn$0 next$0 lst_1$0 curr_9$0 curr_9$0))) :named P18))
...
(assert (! (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 null$0) (not (Btwn$0 next$0 lst_1$0 l1 null$0)))
                 (not (in$0 l1 (lseg_domain$0 next$0 lst_1$0 null$0)))))) :named P20))

(assert (! (or (Btwn$0 next$0 lst_1$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_21$0 next$0 lst_1$0 null$0))) :named P21))

(assert (! (= FP_Caller_3$0 (setminus$0 FP_Caller$0 FP$0)) :named P22))

(assert (! (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)) :named P23))

(assert (! (= sk_?X_21$0 (lseg_domain$0 next$0 lst_1$0 null$0)) :named P24))

(assert (! (lseg_struct$0 sk_?X_21$0 next$0 lst_1$0 null$0) :named P25))

(assert (! (= sk_?X_23$0 (lseg_domain$0 next$0 curr_9$0 null$0)) :named P26))

(assert (! (= sk_FP_2$0 sk_?X_22$0) :named P27))

(assert (! (not (= lst_1$0 null$0)) :named P28))
...
(assert (! (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 null$0) (not (Btwn$0 next$0 curr_9$0 l1 null$0)))
                 (not (in$0 l1 (lseg_domain$0 next$0 curr_9$0 null$0)))))) :named P29))
...
(assert (! (forall ((l1 Loc))
        (or
            ...
            (and
                 ...
                 (not (in$0 l1 (lseg_domain$0 next$0 lst_1$0 curr_9$0)))))) :named P30))
...
(get-interpolants (and P0 P19 P37 P12 P29 P13 P5 P6 P25 P32 P9 P20 P22 P28 P3 P23 P1 P30 P11) (and P10 P15 P14 P4 P7 P8 P16 P17 P2 P34 P35 P26 P21 P31 P36 P27 P33 P18 P24))

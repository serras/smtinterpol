...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (or (in$0 x (setenum$0 lst$0)) (not (in$0 x Alloc$0)))
                 (not (in$0 x (setminus$0 Alloc$0 (setenum$0 lst$0))))))) :named P8))
...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (or (in$0 x (setenum$0 lst$0)) (not (in$0 x FP$0)))
                 (not (in$0 x (setminus$0 FP$0 (setenum$0 lst$0))))))) :named P9))
...
(assert (! (or (Btwn$0 next$0 lst$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_2$0 next$0 lst$0 null$0))) :named P14))

(assert (! (= Alloc_1$0 (setminus$0 Alloc$0 (setenum$0 lst$0))) :named P15))

(assert (! (= FP_Caller_1$0 (setminus$0 FP_Caller$0 FP$0)) :named P16))

(assert (! (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)) :named P17))

(assert (! (= sk_?X_2$0 (lseg_domain$0 next$0 lst$0 null$0)) :named P18))

(assert (! (lseg_struct$0 sk_?X_2$0 next$0 lst$0 null$0) :named P19))

(assert (! (= sk_FP$0 sk_?X_3$0) :named P20))

(assert (! (not (= lst$0 null$0)) :named P21))
...
(assert (! (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 null$0) (not (Btwn$0 next$0 lst$0 l1 null$0)))
                 (not (in$0 l1 (lseg_domain$0 next$0 lst$0 null$0)))))) :named P22))

(assert (! (or (Btwn$0 next$0 n_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_3$0 next$0 n_2$0 null$0))) :named P23))

(assert (! (= FP_1$0 (setminus$0 FP$0 (setenum$0 lst$0))) :named P24))

(assert (! (= n_2$0 (read$0 next$0 lst$0)) :named P25))

(assert (! (= sk_?X_2$0 FP$0) :named P26))

(assert (! (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)) :named P27))

(assert (! (= sk_?X_3$0 (lseg_domain$0 next$0 n_2$0 null$0)) :named P28))
...
(get-interpolants (and P7 P11 P37 P3 P36 P27 P26 P0 P5 P29 P9 P31 P14 P18 P16 P24 P23 P4 P21 P19) (and P35 P32 P20 P15 P6 P22 P28 P30 P1 P38 P2 P17 P25 P33 P34 P13 P10 P8 P12))

...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_47$0)) (not (in$0 x sk_?X_45$0))
                 (not (in$0 x (union$0 sk_?X_47$0 sk_?X_45$0)))))) :named P11))
...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_46$0)) (not (in$0 x sk_?X_45$0))
                 (not (in$0 x (union$0 sk_?X_46$0 sk_?X_45$0)))))) :named P12))
...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_50$0)) (not (in$0 x sk_?X_49$0))
                 (not (in$0 x (union$0 sk_?X_50$0 sk_?X_49$0)))))) :named P13))
...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_46$0)) (not (in$0 x sk_?X_45$0)))
                 (not (in$0 x (intersection$0 sk_?X_46$0 sk_?X_45$0)))))) :named P14))
...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_47$0)) (not (in$0 x sk_?X_45$0)))
                 (not (in$0 x (intersection$0 sk_?X_47$0 sk_?X_45$0)))))) :named P15))
...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_50$0)) (not (in$0 x sk_?X_49$0)))
                 (not (in$0 x (intersection$0 sk_?X_50$0 sk_?X_49$0)))))) :named P16))
...
(assert (! (or (Btwn$0 next$0 curr_init$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_45$0 next$0 curr_init$0 null$0))) :named P21))
...
(assert (! (= sk_?X_43$0 (union$0 sk_?X_47$0 sk_?X_45$0)) :named P27))

(assert (! (= sk_?X_45$0 (lseg_domain$0 next$0 curr_init$0 null$0)) :named P28))

(assert (! (= sk_?X_47$0 (union$0 sk_?X_50$0 sk_?X_48$0)) :named P29))

(assert (! (= sk_?X_49$0 (setenum$0 prv_init$0)) :named P30))
...
(assert (! (or (Btwn$0 next$0 res_init$0 prv_init$0 prv_init$0)
    (not (lseg_struct$0 sk_?X_50$0 next$0 res_init$0 prv_init$0))) :named P35))
...
(assert (! (= sk_?X_44$0 (union$0 sk_?X_46$0 sk_?X_45$0)) :named P41))

(assert (! (= sk_?X_46$0 emptyset$0) :named P42))

(assert (! (= sk_?X_48$0 sk_?X_49$0) :named P43))

(assert (! (= sk_?X_50$0 (lseg_domain$0 next$0 res_init$0 prv_init$0)) :named P44))
...
(assert (! (or
    ...
    (and (= emptyset$0 emptyset$0)
         ...
         (lseg_struct$0 sk_?X_45$0 next$0 curr_init$0 null$0))) :named P45))

(assert (! (not (= prv_4$0 null$0)) :named P46))

(assert (! (not (in$0 old_curr_4$0 FP$0)) :named P47))
...
(get-interpolants (and P44 P46 P25 P31 P29 P33 P50 P1 P37 P45 P34 P43 P36 P8 P13 P54 P49 P40 P39 P0 P5 P12 P26 P6 P17 P7 P51 P27) (and P2 P14 P35 P53 P38 P10 P41 P20 P11 P55 P15 P4 P28 P19 P30 P23 P52 P22 P32 P48 P21 P42 P3 P16 P9 P18 P24 P47))

...
(assert (! (or (in$0 (ep$0 next$0 FP_1$0 lst$0) FP_1$0)
    (= lst$0 (ep$0 next$0 FP_1$0 lst$0))) :named P7))

(assert (! (or (in$0 (ep$0 next$0 FP_1$0 n_2$0) FP_1$0)
    (= n_2$0 (ep$0 next$0 FP_1$0 n_2$0))) :named P8))

(assert (! (or (in$0 (ep$0 next$0 FP_1$0 sk_?e_1$0) FP_1$0)
    (= sk_?e_1$0 (ep$0 next$0 FP_1$0 sk_?e_1$0))) :named P9))
...
(assert (! (forall ((?y Loc))
        (or (Btwn$0 next$0 lst$0 (ep$0 next$0 FP_1$0 lst$0) ?y)
            (not (Btwn$0 next$0 lst$0 ?y ?y)) (not (in$0 ?y FP_1$0)))) :named P11))

(assert (! (forall ((?y Loc))
        (or (Btwn$0 next$0 n_2$0 (ep$0 next$0 FP_1$0 n_2$0) ?y)
            (not (Btwn$0 next$0 n_2$0 ?y ?y)) (not (in$0 ?y FP_1$0)))) :named P12))

(assert (! (forall ((?y Loc))
        (or (Btwn$0 next$0 sk_?e_1$0 (ep$0 next$0 FP_1$0 sk_?e_1$0) ?y)
            (not (Btwn$0 next$0 sk_?e_1$0 ?y ?y)) (not (in$0 ?y FP_1$0)))) :named P13))

(assert (! (Btwn$0 next$0 null$0 (ep$0 next$0 FP_1$0 null$0)
  (ep$0 next$0 FP_1$0 null$0)) :named P14))

(assert (! (Btwn$0 next$0 lst$0 (ep$0 next$0 FP_1$0 lst$0) (ep$0 next$0 FP_1$0 lst$0)) :named P15))

(assert (! (Btwn$0 next$0 n_2$0 (ep$0 next$0 FP_1$0 n_2$0) (ep$0 next$0 FP_1$0 n_2$0)) :named P16))

(assert (! (Btwn$0 next$0 sk_?e_1$0 (ep$0 next$0 FP_1$0 sk_?e_1$0)
  (ep$0 next$0 FP_1$0 sk_?e_1$0)) :named P17))
        ...
        (or
            ...
            (and (not (in$0 x (intersection$0 Alloc$0 FP_1$0)))
                 ...
                 (not
                      (in$0 x
                        (union$0 (intersection$0 Alloc$0 FP_1$0)
                          (setminus$0 Alloc$0 Alloc$0))))))) :named P18))
            ...
            (and (not (in$0 x (setminus$0 FP$0 FP_1$0)))
                 ...
                 (not
                      (in$0 x
                        (union$0 (setminus$0 FP$0 FP_1$0)
                          (union$0 (intersection$0 Alloc$0 FP_1$0)
                            (setminus$0 Alloc$0 Alloc$0)))))))) :named P19))
...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x FP_2$0)) (not (in$0 x Alloc$0))
                 (not (in$0 x (union$0 FP_2$0 Alloc$0)))))) :named P21))
...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x FP_Caller_1$0)) (not (in$0 x FP_2$0))
                 (not (in$0 x (union$0 FP_Caller_1$0 FP_2$0)))))) :named P24))
...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x Alloc$0)) (not (in$0 x FP$0)))
                 (not (in$0 x (intersection$0 Alloc$0 FP$0)))))) :named P26))
...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x Alloc$0)) (not (in$0 x FP_1$0)))
                 (not (in$0 x (intersection$0 Alloc$0 FP_1$0)))))) :named P27))
...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (or (in$0 x Alloc$0) (not (in$0 x Alloc$0)))
                 (not (in$0 x (setminus$0 Alloc$0 Alloc$0)))))) :named P28))
...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (or (in$0 x FP_1$0) (not (in$0 x FP$0)))
                 (not (in$0 x (setminus$0 FP$0 FP_1$0)))))) :named P29))
...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (or (in$0 x FP$0) (not (in$0 x FP_Caller$0)))
                 (not (in$0 x (setminus$0 FP_Caller$0 FP$0)))))) :named P30))

(assert (! (forall ((y Loc) (x Loc))
        (or (and (= x y) (in$0 x (setenum$0 y)))
            (and (not (= x y)) (not (in$0 x (setenum$0 y)))))) :named P31))

(assert (! (= (read$0 next$0 null$0) null$0) :named P32))

(assert (! (forall ((x Loc)) (not (in$0 x emptyset$0))) :named P33))

(assert (! (or (Btwn$0 next$0 lst$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_4$0 next$0 lst$0 null$0))) :named P34))

(assert (! (or (Btwn$0 next$0 n_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_6$0 next$0 n_2$0 null$0))) :named P35))

(assert (! (= FP_Caller_1$0 (setminus$0 FP_Caller$0 FP$0)) :named P36))

(assert (! (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)) :named P37))

(assert (! (= sk_?X_3$0 (lseg_domain$0 next$0 lst$0 null$0)) :named P38))

(assert (! (lseg_struct$0 sk_?X_3$0 next$0 lst$0 null$0) :named P39))
...
(assert (! (or
    ...
    (not (Btwn$0 next$0 lst$0 null$0 null$0))) :named P40))
...
(assert (! (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 null$0) (not (Btwn$0 next$0 lst$0 l1 null$0)))
                 (not (in$0 l1 (lseg_domain$0 next$0 lst$0 null$0)))))) :named P41))

(assert (! (or (Btwn$0 next$0 lst$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_3$0 next$0 lst$0 null$0))) :named P42))

(assert (! (or (Btwn$0 next$0 n_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_5$0 next$0 n_2$0 null$0))) :named P43))
...
(assert (! (or
    ...
    (and (= FP_2$0 FP$0) (= lst$0 null$0) (= n_2$0 n$0))) :named P44))

(assert (! (= FP_Caller_final_1$0 (union$0 FP_Caller_1$0 FP_2$0)) :named P45))

(assert (! (= sk_?X_3$0 FP$0) :named P46))

(assert (! (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)) :named P47))

(assert (! (= sk_?X_4$0
  (union$0 (intersection$0 Alloc$0 FP$0) (setminus$0 Alloc$0 Alloc$0))) :named P48))
...
(get-interpolants (and P18 P50 P14 P11 P9 P40 P26 P55 P27 P49 P2 P56 P46 P0 P32 P38 P13 P44 P45 P53 P30 P20 P15 P5 P12 P24 P34 P41 P10) (and P17 P51 P16 P1 P37 P23 P28 P47 P42 P52 P48 P21 P33 P7 P8 P19 P31 P25 P39 P6 P22 P57 P54 P43 P29 P36 P4 P35 P3))

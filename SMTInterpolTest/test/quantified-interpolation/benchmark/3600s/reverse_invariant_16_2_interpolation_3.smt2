...
(assert (! (forall ((?y Loc))
        (or (not (= (read$0 next$0 rev_1$0) rev_1$0))
            (not (Btwn$0 next$0 rev_1$0 ?y ?y)) (= rev_1$0 ?y))) :named P1))

(assert (! (Btwn$0 next$0 rev_1$0 (read$0 next$0 rev_1$0) (read$0 next$0 rev_1$0)) :named P2))
...
(assert (! (or (Btwn$0 next$0 curr_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_2$0 next$0 curr_2$0 null$0))) :named P11))

(assert (! (or (Btwn$0 next$0 rev_1$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_3$0 next$0 rev_1$0 null$0))) :named P12))

(assert (! (= curr_2$0 lst$0) :named P13))

(assert (! (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)) :named P14))

(assert (! (= sk_?X$0 (lseg_domain$0 next$0 lst$0 null$0)) :named P15))

(assert (! (lseg_struct$0 sk_?X$0 next$0 lst$0 null$0) :named P16))

(assert (! (= sk_?X_2$0 (lseg_domain$0 next$0 curr_2$0 null$0)) :named P17))

(assert (! (= sk_FP$0 sk_?X_1$0) :named P18))

(assert (! (not (in$0 null$0 Alloc$0)) :named P19))
...
(assert (! (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 null$0) (not (Btwn$0 next$0 lst$0 l1 null$0)))
                 (not (in$0 l1 (lseg_domain$0 next$0 lst$0 null$0)))))) :named P20))

(assert (! (or (Btwn$0 next$0 lst$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X$0 next$0 lst$0 null$0))) :named P21))

(assert (! (= FP_Caller_1$0 (setminus$0 FP_Caller$0 FP$0)) :named P22))

(assert (! (= rev_1$0 null$0) :named P23))

(assert (! (= sk_?X$0 FP$0) :named P24))

(assert (! (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)) :named P25))

(assert (! (= sk_?X_1$0 (union$0 sk_?X_3$0 sk_?X_2$0)) :named P26))

(assert (! (= sk_?X_3$0 (lseg_domain$0 next$0 rev_1$0 null$0)) :named P27))
...
(assert (! (or (in$0 sk_?e$0 (intersection$0 sk_?X_3$0 sk_?X_2$0))
    ...
    (not (Btwn$0 next$0 rev_1$0 null$0 null$0))) :named P28))
...
(assert (! (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 null$0) (not (Btwn$0 next$0 curr_2$0 l1 null$0)))
                 (not (in$0 l1 (lseg_domain$0 next$0 curr_2$0 null$0)))))) :named P29))
...
(assert (! (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 null$0) (not (Btwn$0 next$0 rev_1$0 l1 null$0)))
                 (not (in$0 l1 (lseg_domain$0 next$0 rev_1$0 null$0)))))) :named P30))
...
(get-interpolants (and P14 P11 P30 P9 P3 P4 P28 P17 P29 P1 P8 P36 P16 P5 P18 P6 P35 P25 P20) (and P22 P31 P34 P2 P12 P0 P21 P37 P32 P19 P15 P10 P33 P26 P7 P23 P24 P13 P27))

...
(assert (! (forall ((?y Loc))
        (or (not (Btwn$0 next$0 lst$0 ?y ?y)) (= lst$0 ?y)
            (Btwn$0 next$0 lst$0 (read$0 next$0 lst$0) ?y))) :named P0))

(assert (! (forall ((?y Loc))
        (or (not (= (read$0 next$0 lst$0) lst$0))
            (not (Btwn$0 next$0 lst$0 ?y ?y)) (= lst$0 ?y))) :named P1))

(assert (! (Btwn$0 next$0 lst$0 (read$0 next$0 lst$0) (read$0 next$0 lst$0)) :named P2))
...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x FP_Caller_1$0)) (not (in$0 x FP$0))
                 (not (in$0 x (union$0 FP_Caller_1$0 FP$0)))))) :named P5))
...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x Alloc$0)) (not (in$0 x FP$0)))
                 (not (in$0 x (intersection$0 Alloc$0 FP$0)))))) :named P7))
...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (or (in$0 x Alloc$0) (not (in$0 x Alloc$0)))
                 (not (in$0 x (setminus$0 Alloc$0 Alloc$0)))))) :named P8))
...
(assert (! (or (Btwn$0 next$0 lst$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X$0 next$0 lst$0 null$0))) :named P13))

(assert (! (= FP_Caller_1$0 (setminus$0 FP_Caller$0 FP$0)) :named P14))

(assert (! (= lst$0 null$0) :named P15))

(assert (! (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)) :named P16))

(assert (! (= sk_?X$0 (lseg_domain$0 next$0 lst$0 null$0)) :named P17))

(assert (! (lseg_struct$0 sk_?X$0 next$0 lst$0 null$0) :named P18))
...
(assert (! (or
    ...
    (not (Btwn$0 next$0 res_2$0 null$0 null$0))) :named P19))
...
(assert (! (or (Btwn$0 next$0 res_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_1$0 next$0 res_2$0 null$0))) :named P21))

(assert (! (= FP_Caller_final_2$0 (union$0 FP_Caller_1$0 FP$0)) :named P22))

(assert (! (= res_2$0 null$0) :named P23))
...
(assert (! (= sk_?X_1$0
  (union$0 (intersection$0 Alloc$0 FP$0) (setminus$0 Alloc$0 Alloc$0))) :named P26))
...
(assert (! (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 null$0) (not (Btwn$0 next$0 res_2$0 l1 null$0)))
                 (not (in$0 l1 (lseg_domain$0 next$0 res_2$0 null$0)))))) :named P28))
...
(get-interpolants (and P28 P31 P15 P22 P17 P11 P6 P19 P35 P30 P1 P3 P8 P29 P9 P5 P13 P18) (and P10 P16 P24 P32 P34 P12 P23 P21 P0 P2 P14 P27 P20 P7 P26 P33 P25 P4))

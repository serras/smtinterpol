...
(assert (! (or
    ...
    (not (Btwn$0 next$0 res_3$0 null$0 null$0))) :named P19))
...
(assert (! (or (Btwn$0 next$0 res_3$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_1$0 next$0 res_3$0 null$0))) :named P21))

(assert (! (= FP_Caller_final_3$0 (union$0 FP_Caller_1$0 FP$0)) :named P22))

(assert (! (= res_3$0 null$0) :named P23))
...
(assert (! (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 null$0) (not (Btwn$0 next$0 res_3$0 l1 null$0)))
                 (not (in$0 l1 (lseg_domain$0 next$0 res_3$0 null$0)))))) :named P28))
...
(get-interpolants (and P0 P2 P18 P17 P24 P34 P5 P21 P12 P1 P13 P31 P8 P29 P10 P11 P14 P20) (and P16 P28 P22 P19 P15 P33 P9 P32 P25 P30 P26 P35 P3 P4 P27 P7 P23 P6))

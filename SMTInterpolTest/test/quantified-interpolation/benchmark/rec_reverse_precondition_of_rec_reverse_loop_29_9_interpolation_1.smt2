...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x FP$0)) (not (in$0 x sk_?X_74$0))
                 (not (in$0 x (union$0 FP$0 sk_?X_74$0)))))) :named P5))
...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x FP$0)) (not (in$0 x sk_?X_74$0)))
                 (not (in$0 x (intersection$0 FP$0 sk_?X_74$0)))))) :named P6))
...
(assert (! (or (Btwn$0 next$0 lst_1$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_72$0 next$0 lst_1$0 null$0))) :named P11))

(assert (! (= FP_Caller_3$0 (setminus$0 FP_Caller$0 FP$0)) :named P12))

(assert (! (= sk_?X_72$0 FP$0) :named P13))

(assert (! (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)) :named P14))

(assert (! (= sk_?X_73$0 (union$0 sk_?X_75$0 sk_?X_74$0)) :named P15))

(assert (! (= sk_?X_75$0 (lseg_domain$0 next$0 lst_1$0 null$0)) :named P16))
...
(assert (! (or (in$0 sk_?e_6$0 (intersection$0 sk_?X_75$0 sk_?X_74$0))
    ...
    (not (Btwn$0 next$0 lst_1$0 null$0 null$0))) :named P17))
...
(assert (! (or (Btwn$0 next$0 null$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_74$0 next$0 null$0 null$0))) :named P19))

(assert (! (or (Btwn$0 next$0 lst_1$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_75$0 next$0 lst_1$0 null$0))) :named P20))

(assert (! (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)) :named P21))

(assert (! (= sk_?X_72$0 (lseg_domain$0 next$0 lst_1$0 null$0)) :named P22))

(assert (! (lseg_struct$0 sk_?X_72$0 next$0 lst_1$0 null$0) :named P23))

(assert (! (= sk_?X_74$0 (lseg_domain$0 next$0 null$0 null$0)) :named P24))

(assert (! (= sk_FP_3$0 sk_?X_73$0) :named P25))
...
(assert (! (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 null$0) (not (Btwn$0 next$0 lst_1$0 l1 null$0)))
                 (not (in$0 l1 (lseg_domain$0 next$0 lst_1$0 null$0)))))) :named P27))
...
(get-interpolants (and P4 P18 P25 P6 P29 P28 P0 P10 P2 P12 P34 P33 P20 P13 P19 P26 P21 P11) (and P22 P31 P14 P16 P8 P3 P9 P27 P24 P23 P32 P30 P1 P7 P17 P5 P15))

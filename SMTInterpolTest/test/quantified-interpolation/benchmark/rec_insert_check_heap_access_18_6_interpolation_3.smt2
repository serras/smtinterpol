...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_8$0)) (not (in$0 x sk_?X_6$0)))
                 (not (in$0 x (intersection$0 sk_?X_8$0 sk_?X_6$0)))))) :named P9))
...
(assert (! (or (Btwn$0 next$0 lst$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_8$0 next$0 lst$0 null$0))) :named P14))

(assert (! (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)) :named P15))

(assert (! (= (read$0 next$0 elt$0) null$0) :named P16))

(assert (! (= emptyset$0 (intersection$0 sk_?X_8$0 sk_?X_6$0)) :named P17))

(assert (! (= sk_?X_5$0 FP$0) :named P18))

(assert (! (= sk_?X_7$0 (setenum$0 elt$0)) :named P19))

(assert (! (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)) :named P20))

(assert (! (not (= lst$0 null$0)) :named P21))

(assert (! (not (in$0 elt$0 FP$0)) :named P22))

(assert (! (= FP_Caller_1$0 (setminus$0 FP_Caller$0 FP$0)) :named P23))

(assert (! nondet_1$0 :named P24))

(assert (! (= emptyset$0 emptyset$0) :named P25))

(assert (! (= sk_?X_5$0 (union$0 sk_?X_8$0 sk_?X_6$0)) :named P26))

(assert (! (= sk_?X_6$0 sk_?X_7$0) :named P27))

(assert (! (= sk_?X_8$0 (lseg_domain$0 next$0 lst$0 null$0)) :named P28))

(assert (! (lseg_struct$0 sk_?X_8$0 next$0 lst$0 null$0) :named P29))
...
(get-interpolants (and P18 P26 P11 P17 P14 P37 P36 P10 P29 P2 P15 P35 P0 P23 P22 P19 P31 P13 P6 P3) (and P21 P27 P38 P25 P5 P28 P24 P12 P8 P16 P20 P1 P9 P34 P7 P33 P4 P30 P32))

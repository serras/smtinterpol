...
(assert (! (or (Btwn$0 next$0 rev_init$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_14$0 next$0 rev_init$0 null$0))) :named P11))

(assert (! (= curr_4$0 curr_init$0) :named P12))

(assert (! (= tmp_2$0 tmp_init$0) :named P13))

(assert (! (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)) :named P14))

(assert (! (= sk_?X_12$0 (union$0 sk_?X_14$0 sk_?X_13$0)) :named P15))

(assert (! (= sk_?X_13$0 (lseg_domain$0 next$0 curr_init$0 null$0)) :named P16))

(assert (! (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)) :named P17))

(assert (! (lseg_struct$0 sk_?X_14$0 next$0 rev_init$0 null$0) :named P18))
...
(assert (! (forall ((l1 Loc))
        (or
            ...
            (and
                 ...
                 (not (in$0 l1 (lseg_domain$0 next$0 curr_init$0 null$0)))))) :named P20))

(assert (! (or (Btwn$0 next$0 curr_init$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_13$0 next$0 curr_init$0 null$0))) :named P21))

(assert (! (= FP_Caller_2$0 (setminus$0 FP_Caller$0 FP$0)) :named P22))

(assert (! (= rev_3$0 rev_init$0) :named P23))

(assert (! (= tmp_4$0 curr_4$0) :named P24))

(assert (! (= emptyset$0 (intersection$0 sk_?X_14$0 sk_?X_13$0)) :named P25))

(assert (! (= sk_?X_12$0 FP$0) :named P26))

(assert (! (= sk_?X_14$0 (lseg_domain$0 next$0 rev_init$0 null$0)) :named P27))

(assert (! (lseg_struct$0 sk_?X_13$0 next$0 curr_init$0 null$0) :named P28))

(assert (! (not (= curr_4$0 null$0)) :named P29))

(assert (! (not (in$0 curr_4$0 FP$0)) :named P30))
...
(assert (! (forall ((l1 Loc))
        (or
            ...
            (and
                 ...
                 (not (in$0 l1 (lseg_domain$0 next$0 rev_init$0 null$0)))))) :named P31))
...
(get-interpolants (and P23 P17 P3 P0 P16 P8 P12 P27 P31 P25 P15 P4 P34 P28 P22 P19 P6 P33 P5 P14) (and P18 P29 P32 P21 P37 P1 P11 P13 P7 P10 P20 P24 P2 P9 P35 P38 P36 P30 P26))

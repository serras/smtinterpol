...
(assert (! (= curr_4$0 lst_2$0) :named P13))

(assert (! (= lst_3$0 (read$0 next$0 lst_2$0)) :named P14))

(assert (! (= sk_?X_6$0 FP$0) :named P15))

(assert (! (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)) :named P16))

(assert (! (not (= lst_2$0 null$0)) :named P17))

(assert (! (not (in$0 curr_4$0 FP$0)) :named P18))

(assert (! (or (Btwn$0 next$0 lst_init$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_6$0 next$0 lst_init$0 null$0))) :named P19))

(assert (! (= curr_2$0 curr_init$0) :named P20))

(assert (! (= lst_2$0 lst_init$0) :named P21))

(assert (! (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)) :named P22))

(assert (! (= sk_?X_6$0 (lseg_domain$0 next$0 lst_init$0 null$0)) :named P23))

(assert (! (lseg_struct$0 sk_?X_6$0 next$0 lst_init$0 null$0) :named P24))

(assert (! (not (in$0 null$0 Alloc$0)) :named P25))
...
(assert (! (forall ((l1 Loc))
        (or
            ...
            (and
                 ...
                 (not (in$0 l1 (lseg_domain$0 next$0 lst_init$0 null$0)))))) :named P26))

(assert (! (forall ((?x Loc)) (Btwn$0 next$0 ?x ?x ?x)) :named P27))

(assert (! (forall ((?x Loc) (?y Loc)) (or (not (Btwn$0 next$0 ?x ?y ?x)) (= ?x ?y))) :named P28))

(assert (! (forall ((?x Loc) (?y Loc) (?z Loc))
        (or (not (Btwn$0 next$0 ?x ?y ?y)) (not (Btwn$0 next$0 ?x ?z ?z))
            (Btwn$0 next$0 ?x ?y ?z) (Btwn$0 next$0 ?x ?z ?y))) :named P29))

(assert (! (forall ((?x Loc) (?y Loc) (?z Loc))
        (or (not (Btwn$0 next$0 ?x ?y ?z))
            (and (Btwn$0 next$0 ?x ?y ?y) (Btwn$0 next$0 ?y ?z ?z)))) :named P30))

(assert (! (forall ((?x Loc) (?y Loc) (?z Loc))
        (or (not (Btwn$0 next$0 ?x ?y ?y)) (not (Btwn$0 next$0 ?y ?z ?z))
            (Btwn$0 next$0 ?x ?z ?z))) :named P31))

(assert (! (forall ((?u Loc) (?x Loc) (?y Loc) (?z Loc))
        (or (not (Btwn$0 next$0 ?x ?y ?z)) (not (Btwn$0 next$0 ?y ?u ?z))
            (and (Btwn$0 next$0 ?x ?y ?u) (Btwn$0 next$0 ?x ?u ?z)))) :named P32))

(assert (! (forall ((?u Loc) (?x Loc) (?y Loc) (?z Loc))
        (or (not (Btwn$0 next$0 ?x ?y ?z)) (not (Btwn$0 next$0 ?x ?u ?y))
            (and (Btwn$0 next$0 ?x ?u ?z) (Btwn$0 next$0 ?u ?y ?z)))) :named P33))

(check-sat)

(get-interpolants (and P9 P32 P3 P8 P2 P23 P33 P20 P12 P13 P27 P10 P7 P14 P28 P15 P1) (and P26 P11 P6 P16 P0 P25 P31 P17 P30 P22 P5 P4 P19 P24 P29 P21 P18))

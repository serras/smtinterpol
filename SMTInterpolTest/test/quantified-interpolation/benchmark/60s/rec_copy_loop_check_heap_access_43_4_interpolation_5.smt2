...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x Alloc$0)) (not (in$0 x (setenum$0 tmp_1$0)))
                 (not (in$0 x (union$0 Alloc$0 (setenum$0 tmp_1$0))))))) :named P4))
...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_38$0)) (not (in$0 x sk_?X_37$0))
                 (not (in$0 x (union$0 sk_?X_38$0 sk_?X_37$0)))))) :named P5))
...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x FP$0)) (not (in$0 x (setenum$0 tmp_1$0)))
                 (not (in$0 x (union$0 FP$0 (setenum$0 tmp_1$0))))))) :named P6))
...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_38$0)) (not (in$0 x sk_?X_37$0)))
                 (not (in$0 x (intersection$0 sk_?X_38$0 sk_?X_37$0)))))) :named P8))
...
(assert (! (or (Btwn$0 next$0 curr$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_37$0 next$0 curr$0 null$0))) :named P13))

(assert (! (= FP_3$0 (union$0 FP$0 (setenum$0 tmp_1$0))) :named P14))

(assert (! (= cp_1$0 tmp_1$0) :named P15))

(assert (! (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)) :named P16))

(assert (! (= sk_?X_36$0 (union$0 sk_?X_38$0 sk_?X_37$0)) :named P17))

(assert (! (= sk_?X_37$0 (lseg_domain$0 next$0 curr$0 null$0)) :named P18))

(assert (! (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)) :named P19))

(assert (! (lseg_struct$0 sk_?X_38$0 next$0 cp$0 null$0) :named P20))

(assert (! (not (= tmp_1$0 null$0)) :named P21))

(assert (! (not (in$0 cp_1$0 FP_3$0)) :named P22))
...
(assert (! (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 null$0) (not (Btwn$0 next$0 cp$0 l1 null$0)))
                 (not (in$0 l1 (lseg_domain$0 next$0 cp$0 null$0)))))) :named P23))

(assert (! (or (Btwn$0 next$0 cp$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_38$0 next$0 cp$0 null$0))) :named P24))

(assert (! (= Alloc_2$0 (union$0 Alloc$0 (setenum$0 tmp_1$0))) :named P25))

(assert (! (= FP_Caller_2$0 (setminus$0 FP_Caller$0 FP$0)) :named P26))

(assert (! (= old_cp_2$0 cp$0) :named P27))

(assert (! (= emptyset$0 (intersection$0 sk_?X_38$0 sk_?X_37$0)) :named P28))

(assert (! (= sk_?X_36$0 FP$0) :named P29))

(assert (! (= sk_?X_38$0 (lseg_domain$0 next$0 cp$0 null$0)) :named P30))

(assert (! (lseg_struct$0 sk_?X_37$0 next$0 curr$0 null$0) :named P31))

(assert (! (not (= curr$0 null$0)) :named P32))

(assert (! (not (in$0 null$0 Alloc$0)) :named P33))

(assert (! (not (in$0 tmp_1$0 Alloc$0)) :named P34))
...
(get-interpolants (and P1 P22 P10 P25 P24 P20 P6 P42 P30 P28 P3 P8 P16 P2 P40 P27 P38 P12 P31 P29 P18 P39) (and P7 P32 P5 P33 P23 P35 P15 P14 P11 P19 P34 P41 P0 P17 P36 P4 P37 P26 P13 P9 P21))

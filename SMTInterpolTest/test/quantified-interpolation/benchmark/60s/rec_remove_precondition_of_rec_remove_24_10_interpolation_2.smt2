...
(assert (! (or (Btwn$0 next$0 n1_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_8$0 next$0 n1_2$0 null$0))) :named P12))

(assert (! (= n1_2$0 (read$0 next$0 lst$0)) :named P13))

(assert (! (= sk_?X_7$0 FP$0) :named P14))

(assert (! (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)) :named P15))

(assert (! (= sk_?X_8$0 (lseg_domain$0 next$0 n1_2$0 null$0)) :named P16))

(assert (! (or (and (in$0 sk_?e_2$0 sk_FP$0) (not (in$0 sk_?e_2$0 FP$0)))
    (not (Btwn$0 next$0 n1_2$0 null$0 null$0))) :named P17))
...
(assert (! (or (Btwn$0 next$0 lst$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_7$0 next$0 lst$0 null$0))) :named P20))

(assert (! (= FP_Caller_1$0 (setminus$0 FP_Caller$0 FP$0)) :named P21))

(assert (! (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)) :named P22))

(assert (! (= sk_?X_7$0 (lseg_domain$0 next$0 lst$0 null$0)) :named P23))

(assert (! (lseg_struct$0 sk_?X_7$0 next$0 lst$0 null$0) :named P24))

(assert (! (= sk_FP$0 sk_?X_8$0) :named P25))

(assert (! (not (= lst$0 null$0)) :named P26))

(assert (! (not nondet_1$0) :named P27))
...
(assert (! (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 null$0) (not (Btwn$0 next$0 n1_2$0 l1 null$0)))
                 (not (in$0 l1 (lseg_domain$0 next$0 n1_2$0 null$0)))))) :named P28))
...
(get-interpolants (and P6 P4 P19 P31 P5 P20 P29 P16 P11 P18 P35 P0 P34 P9 P22 P15 P26 P25) (and P14 P24 P27 P2 P12 P17 P3 P33 P28 P32 P7 P30 P8 P13 P21 P1 P10 P23))

...
(assert (! (forall ((?y Loc))
        (or (not (Btwn$0 next$0 x$0 ?y ?y)) (= x$0 ?y)
            (Btwn$0 next$0 x$0 (read$0 next$0 x$0) ?y))) :named P0))

(assert (! (forall ((?y Loc))
        (or (not (= (read$0 next$0 x$0) x$0)) (not (Btwn$0 next$0 x$0 ?y ?y))
            (= x$0 ?y))) :named P1))

(assert (! (Btwn$0 next$0 x$0 (read$0 next$0 x$0) (read$0 next$0 x$0)) :named P2))
...
(assert (! (or (Btwn$0 next$0 res_4$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_1$0 next$0 res_4$0 null$0))) :named P13))

(assert (! (= FP_Caller_1$0 (setminus$0 FP_Caller$0 FP$0)) :named P14))

(assert (! (= res_4$0 x$0) :named P15))

(assert (! (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)) :named P16))

(assert (! (= sk_?X$0 (lseg_domain$0 next$0 x$0 null$0)) :named P17))

(assert (! (lseg_struct$0 sk_?X$0 next$0 x$0 null$0) :named P18))
...
(assert (! (or
    ...
    (not (Btwn$0 next$0 res_4$0 null$0 null$0))) :named P19))
...
(assert (! (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 null$0) (not (Btwn$0 next$0 res_4$0 l1 null$0)))
                 (not (in$0 l1 (lseg_domain$0 next$0 res_4$0 null$0)))))) :named P20))

(assert (! (or (Btwn$0 next$0 x$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X$0 next$0 x$0 null$0))) :named P21))

(assert (! (= FP_Caller_final_3$0 (union$0 FP_Caller_1$0 FP$0)) :named P22))

(assert (! (= x$0 null$0) :named P23))
...
(get-interpolants (and P5 P28 P24 P29 P10 P12 P32 P2 P8 P34 P4 P9 P23 P13 P16 P11 P31 P33) (and P21 P35 P3 P25 P27 P19 P7 P20 P0 P1 P6 P30 P18 P17 P15 P14 P22 P26))

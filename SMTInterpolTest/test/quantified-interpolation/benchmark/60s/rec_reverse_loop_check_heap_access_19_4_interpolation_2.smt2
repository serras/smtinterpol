...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_94$0)) (not (in$0 x sk_?X_93$0))
                 (not (in$0 x (union$0 sk_?X_94$0 sk_?X_93$0)))))) :named P4))
...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_94$0)) (not (in$0 x sk_?X_93$0)))
                 (not (in$0 x (intersection$0 sk_?X_94$0 sk_?X_93$0)))))) :named P6))
...
(assert (! (or (Btwn$0 next$0 acc$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_93$0 next$0 acc$0 null$0))) :named P11))

(assert (! (= FP_Caller_4$0 (setminus$0 FP_Caller$0 FP$0)) :named P12))

(assert (! (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)) :named P13))

(assert (! (= sk_?X_92$0 (union$0 sk_?X_94$0 sk_?X_93$0)) :named P14))

(assert (! (= sk_?X_93$0 (lseg_domain$0 next$0 acc$0 null$0)) :named P15))

(assert (! (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)) :named P16))

(assert (! (lseg_struct$0 sk_?X_94$0 next$0 lst_2$0 null$0) :named P17))
...
(assert (! (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 null$0) (not (Btwn$0 next$0 acc$0 l1 null$0)))
                 (not (in$0 l1 (lseg_domain$0 next$0 acc$0 null$0)))))) :named P19))

(assert (! (or (Btwn$0 next$0 lst_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_94$0 next$0 lst_2$0 null$0))) :named P20))

(assert (! (= old_lst_2$0 lst_2$0) :named P21))

(assert (! (= emptyset$0 (intersection$0 sk_?X_94$0 sk_?X_93$0)) :named P22))

(assert (! (= sk_?X_92$0 FP$0) :named P23))

(assert (! (= sk_?X_94$0 (lseg_domain$0 next$0 lst_2$0 null$0)) :named P24))

(assert (! (lseg_struct$0 sk_?X_93$0 next$0 acc$0 null$0) :named P25))

(assert (! (not (= lst_2$0 null$0)) :named P26))

(assert (! (not (in$0 lst_2$0 FP$0)) :named P27))
...
(assert (! (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 null$0) (not (Btwn$0 next$0 lst_2$0 l1 null$0)))
                 (not (in$0 l1 (lseg_domain$0 next$0 lst_2$0 null$0)))))) :named P28))
...
(get-interpolants (and P14 P8 P31 P34 P33 P12 P32 P21 P19 P30 P2 P0 P35 P28 P27 P3 P25 P22) (and P1 P7 P5 P17 P15 P23 P18 P24 P26 P11 P20 P4 P29 P6 P10 P16 P13 P9))

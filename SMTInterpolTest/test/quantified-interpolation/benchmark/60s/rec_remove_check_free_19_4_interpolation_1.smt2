...
(assert (! (= sk_?X_3$0 FP$0) :named P14))
...
(assert (! (= n_2$0 (read$0 next$0 lst$0)) :named P19))

(assert (! nondet_1$0 :named P20))

(assert (! (= sk_?X_3$0 (lseg_domain$0 next$0 lst$0 null$0)) :named P21))

(assert (! (lseg_struct$0 sk_?X_3$0 next$0 lst$0 null$0) :named P22))
...
(get-interpolants (and P20 P30 P19 P3 P25 P7 P21 P31 P24 P12 P11 P26 P6 P5 P4 P14) (and P1 P10 P22 P23 P9 P15 P0 P17 P16 P8 P13 P29 P27 P18 P2 P28))

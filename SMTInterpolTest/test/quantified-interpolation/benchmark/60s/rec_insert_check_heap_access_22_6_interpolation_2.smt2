...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_17$0)) (not (in$0 x sk_?X_15$0))
                 (not (in$0 x (union$0 sk_?X_17$0 sk_?X_15$0)))))) :named P7))
...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_17$0)) (not (in$0 x sk_?X_15$0)))
                 (not (in$0 x (intersection$0 sk_?X_17$0 sk_?X_15$0)))))) :named P9))
...
(assert (! (or (Btwn$0 next$0 lst$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_17$0 next$0 lst$0 null$0))) :named P14))

(assert (! (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)) :named P15))

(assert (! (= emptyset$0 emptyset$0) :named P16))

(assert (! (= sk_?X_14$0 (union$0 sk_?X_17$0 sk_?X_15$0)) :named P17))

(assert (! (= sk_?X_15$0 sk_?X_16$0) :named P18))

(assert (! (= sk_?X_17$0 (lseg_domain$0 next$0 lst$0 null$0)) :named P19))

(assert (! (lseg_struct$0 sk_?X_17$0 next$0 lst$0 null$0) :named P20))

(assert (! (not (in$0 null$0 Alloc$0)) :named P21))

(assert (! (not nondet_1$0) :named P22))

(assert (! (= FP_Caller_1$0 (setminus$0 FP_Caller$0 FP$0)) :named P23))

(assert (! (= (read$0 next$0 elt$0) null$0) :named P24))

(assert (! (= emptyset$0 (intersection$0 sk_?X_17$0 sk_?X_15$0)) :named P25))

(assert (! (= sk_?X_14$0 FP$0) :named P26))

(assert (! (= sk_?X_16$0 (setenum$0 elt$0)) :named P27))

(assert (! (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)) :named P28))

(assert (! (not (= lst$0 null$0)) :named P29))

(assert (! (not (in$0 lst$0 FP$0)) :named P30))
...
(get-interpolants (and P16 P22 P37 P3 P10 P30 P8 P35 P32 P13 P18 P25 P15 P34 P24 P23 P5 P11 P20 P6) (and P38 P29 P0 P28 P21 P2 P9 P31 P1 P12 P17 P4 P33 P19 P26 P7 P36 P27 P14))

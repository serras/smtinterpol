...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_8$0)) (not (in$0 x sk_?X_5$0))
                 (not (in$0 x (union$0 sk_?X_8$0 sk_?X_5$0)))))) :named P4))
...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_10$0)) (not (in$0 x sk_?X_8$0))
                 (not (in$0 x (union$0 sk_?X_10$0 sk_?X_8$0)))))) :named P6))
...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_8$0)) (not (in$0 x sk_?X_5$0)))
                 (not (in$0 x (intersection$0 sk_?X_8$0 sk_?X_5$0)))))) :named P7))
...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_10$0)) (not (in$0 x sk_?X_8$0)))
                 (not (in$0 x (intersection$0 sk_?X_10$0 sk_?X_8$0)))))) :named P8))
...
(assert (! (or (Btwn$0 next$0 a$0 curr_2$0 curr_2$0)
    (not (lseg_struct$0 sk_?X_10$0 next$0 a$0 curr_2$0))) :named P13))

(assert (! (or (Btwn$0 next$0 curr_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_8$0 next$0 curr_2$0 null$0))) :named P14))

(assert (! (= curr_2$0 a$0) :named P15))

(assert (! (= emptyset$0 (intersection$0 sk_?X_6$0 sk_?X_5$0)) :named P16))

(assert (! (= sk_?X_4$0 FP$0) :named P17))

(assert (! (= sk_?X_6$0 (lseg_domain$0 next$0 a$0 null$0)) :named P18))

(assert (! (lseg_struct$0 sk_?X_5$0 next$0 b$0 null$0) :named P19))

(assert (! (= sk_?X_7$0 (union$0 sk_?X_9$0 sk_?X_8$0)) :named P20))

(assert (! (= sk_?X_9$0 sk_?X_10$0) :named P21))

(assert (! (= sk_FP$0 sk_?X_7$0) :named P22))

(assert (! (not (= a$0 null$0)) :named P23))
...
(assert (! (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 null$0) (not (Btwn$0 next$0 a$0 l1 null$0)))
                 (not (in$0 l1 (lseg_domain$0 next$0 a$0 null$0)))))) :named P24))
...
(assert (! (or (Btwn$0 next$0 a$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_6$0 next$0 a$0 null$0))) :named P26))

(assert (! (or (Btwn$0 next$0 b$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_5$0 next$0 b$0 null$0))) :named P27))

(assert (! (= FP_Caller_1$0 (setminus$0 FP_Caller$0 FP$0)) :named P28))

(assert (! (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)) :named P29))

(assert (! (= sk_?X_4$0 (union$0 sk_?X_6$0 sk_?X_5$0)) :named P30))

(assert (! (= sk_?X_5$0 (lseg_domain$0 next$0 b$0 null$0)) :named P31))

(assert (! (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)) :named P32))

(assert (! (lseg_struct$0 sk_?X_6$0 next$0 a$0 null$0) :named P33))

(assert (! (= sk_?X_8$0 (lseg_domain$0 next$0 curr_2$0 null$0)) :named P34))

(assert (! (= sk_?X_10$0 (lseg_domain$0 next$0 a$0 curr_2$0)) :named P35))
...
(assert (! (or (= curr_2$0 null$0) (in$0 sk_?e_1$0 (intersection$0 sk_?X_9$0 sk_?X_8$0))
    ...
    (not (Btwn$0 next$0 curr_2$0 null$0 null$0))) :named P36))
...
(assert (! (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 curr_2$0) (not (Btwn$0 next$0 a$0 l1 curr_2$0)))
                 (not (in$0 l1 (lseg_domain$0 next$0 a$0 curr_2$0)))))) :named P38))
...
(assert (! (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 null$0) (not (Btwn$0 next$0 curr_2$0 l1 null$0)))
                 (not (in$0 l1 (lseg_domain$0 next$0 curr_2$0 null$0)))))) :named P39))
...
(get-interpolants (and P4 P24 P9 P38 P25 P12 P26 P42 P27 P0 P7 P14 P22 P40 P32 P17 P21 P31 P45 P30 P6 P41 P28 P19) (and P13 P20 P16 P37 P43 P8 P18 P1 P33 P29 P36 P46 P11 P5 P39 P44 P10 P23 P3 P2 P35 P34 P15))

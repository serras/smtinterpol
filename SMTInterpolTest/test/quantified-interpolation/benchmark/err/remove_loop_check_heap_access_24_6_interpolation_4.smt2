...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_66$0)) (not (in$0 x sk_?X_64$0))
                 (not (in$0 x (union$0 sk_?X_66$0 sk_?X_64$0)))))) :named P7))
...
(assert (! (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_66$0)) (not (in$0 x sk_?X_64$0)))
                 (not (in$0 x (intersection$0 sk_?X_66$0 sk_?X_64$0)))))) :named P9))
...
(assert (! (or (Btwn$0 next$0 curr_init$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_64$0 next$0 curr_init$0 null$0))) :named P14))
...
(assert (! (= sk_?X_63$0 (union$0 sk_?X_65$0 sk_?X_64$0)) :named P19))

(assert (! (= sk_?X_64$0 (lseg_domain$0 next$0 curr_init$0 null$0)) :named P20))

(assert (! (= sk_?X_66$0 (lseg_domain$0 next$0 lst_init$0 curr_init$0)) :named P21))

(assert (! (lseg_struct$0 sk_?X_64$0 next$0 curr_init$0 null$0) :named P22))
...
(assert (! (or (Btwn$0 next$0 lst_init$0 curr_init$0 curr_init$0)
    (not (lseg_struct$0 sk_?X_66$0 next$0 lst_init$0 curr_init$0))) :named P26))
...
(assert (! (= emptyset$0 (intersection$0 sk_?X_65$0 sk_?X_64$0)) :named P30))

(assert (! (= sk_?X_63$0 FP$0) :named P31))

(assert (! (= sk_?X_65$0 sk_?X_66$0) :named P32))

(assert (! (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)) :named P33))

(assert (! (lseg_struct$0 sk_?X_66$0 next$0 lst_init$0 curr_init$0) :named P34))
...
(get-interpolants (and P30 P5 P1 P16 P22 P28 P31 P9 P24 P10 P0 P39 P25 P6 P21 P14 P37 P41 P20 P13 P17 P33 P44) (and P43 P42 P38 P12 P40 P26 P7 P27 P11 P29 P8 P18 P35 P36 P32 P4 P15 P3 P23 P34 P2 P19))

...
(assert (! (= sk_?X_1$0 (lseg_domain$0 next$0 lst$0 null$0)) :named P15))

(assert (! (lseg_struct$0 sk_?X_1$0 next$0 lst$0 null$0) :named P16))

(assert (! (= sk_FP$0 sk_?X_2$0) :named P17))
...
(assert (! (or (Btwn$0 next$0 n_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_2$0 next$0 n_2$0 null$0))) :named P20))

(assert (! (= n_2$0 (read$0 next$0 lst$0)) :named P21))

(assert (! (= sk_?X_1$0 FP$0) :named P22))

(assert (! (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)) :named P23))

(assert (! (= sk_?X_2$0 (lseg_domain$0 next$0 n_2$0 null$0)) :named P24))

(assert (! (or (and (in$0 sk_?e$0 sk_FP$0) (not (in$0 sk_?e$0 FP$0)))
    (not (Btwn$0 next$0 n_2$0 null$0 null$0))) :named P25))
...
(assert (! (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 null$0) (not (Btwn$0 next$0 n_2$0 l1 null$0)))
                 (not (in$0 l1 (lseg_domain$0 next$0 n_2$0 null$0)))))) :named P27))
...
(get-interpolants (and P33 P9 P30 P1 P2 P20 P27 P16 P13 P15 P26 P8 P11 P14 P22 P17 P0 P29) (and P19 P3 P31 P7 P5 P18 P34 P24 P21 P23 P12 P10 P4 P6 P28 P25 P32))

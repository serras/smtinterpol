...
(assert (! (forall ((?y Loc))
        (or (not (Btwn$0 next$0 a$0 ?y ?y)) (= a$0 ?y)
            (Btwn$0 next$0 a$0 (read$0 next$0 a$0) ?y))) :named P1))
...
(assert (! (Btwn$0 next$0 a$0 (read$0 next$0 a$0) (read$0 next$0 a$0)) :named P5))
...
(assert (! (or (Btwn$0 next$0 a$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_3$0 next$0 a$0 null$0))) :named P12))

(assert (! (= FP_Caller_1$0 (setminus$0 FP_Caller$0 FP$0)) :named P13))

(assert (! (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)) :named P14))

(assert (! (= sk_?X_2$0 sk_?X_3$0) :named P15))

(assert (! (= sk_?X_3$0 (lseg_domain$0 next$0 a$0 null$0)) :named P16))

(assert (! (lseg_struct$0 sk_?X_3$0 next$0 a$0 null$0) :named P17))

(assert (! (= sk_?X_4$0 sk_?X_5$0) :named P18))

(assert (! (= sk_FP$0 sk_?X_4$0) :named P19))

(assert (! (not (= n_2$0 null$0)) :named P20))
...
(assert (! (or (Btwn$0 next$0 n_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_5$0 next$0 n_2$0 null$0))) :named P22))

(assert (! (= n_2$0 (read$0 next$0 a$0)) :named P23))

(assert (! (= emptyset$0 emptyset$0) :named P24))

(assert (! (= sk_?X_2$0 FP$0) :named P25))

(assert (! (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)) :named P26))

(assert (! (not (= a$0 null$0)) :named P27))

(assert (! (= sk_?X_5$0 (lseg_domain$0 next$0 n_2$0 null$0)) :named P28))

(assert (! (or (= n_2$0 null$0) (and (in$0 sk_?e$0 sk_FP$0) (not (in$0 sk_?e$0 FP$0)))
    (not (Btwn$0 next$0 n_2$0 null$0 null$0))) :named P29))
...
(assert (! (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 null$0) (not (Btwn$0 next$0 n_2$0 l1 null$0)))
                 (not (in$0 l1 (lseg_domain$0 next$0 n_2$0 null$0)))))) :named P31))
...
(get-interpolants (and P37 P4 P36 P5 P14 P2 P31 P17 P32 P20 P16 P38 P8 P34 P35 P3 P25 P22 P0 P33) (and P13 P12 P11 P26 P10 P19 P15 P1 P21 P6 P23 P7 P29 P28 P30 P9 P18 P27 P24))

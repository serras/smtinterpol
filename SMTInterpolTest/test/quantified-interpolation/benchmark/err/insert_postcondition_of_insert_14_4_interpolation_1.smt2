...
(assert (! (or
    ...
    (not (Btwn$0 next$0 res_2$0 null$0 null$0))) :named P27))
...
(assert (! (or (Btwn$0 next$0 res_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_4$0 next$0 res_2$0 null$0))) :named P29))

(assert (! (= FP_Caller_final_2$0 (union$0 FP_Caller_1$0 FP$0)) :named P30))

(assert (! (= res_2$0 elt$0) :named P31))
...
(assert (! (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 null$0) (not (Btwn$0 next$0 res_2$0 l1 null$0)))
                 (not (in$0 l1 (lseg_domain$0 next$0 res_2$0 null$0)))))) :named P39))
...
(get-interpolants (and P33 P34 P44 P28 P39 P3 P40 P22 P2 P43 P19 P0 P15 P5 P35 P46 P14 P24 P9 P11 P8 P27 P16 P32) (and P17 P12 P42 P41 P31 P4 P18 P26 P1 P25 P13 P38 P7 P23 P36 P37 P45 P21 P10 P30 P20 P6 P29))
